...
if (KLEVER) { 
  ...
  if (runnumb >= 400464) {
    ...
    devacal[2] = (deva[2]+185.434)/87.5194;
    devacal[3] = (deva[3]+187.077)/71.8283;
    devacal[4] = (deva[4]+177.245)/104.084;
    devacal[5] = (deva[5]+122.320)/100.846;
    devacal[6] = (deva[6]+194.398)/82.7595;
    devacal[7] = (deva[7]+152.962)/86.1368;
