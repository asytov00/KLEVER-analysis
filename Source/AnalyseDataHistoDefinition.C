...
TH2F *hGammaelectronP = new TH2F("hGammaelectronP","Gamma cal energy vs Electrons cal energy; Electrons cal energy, GeV;  Gamma cal energy, GeV", binCalo,EminCalo,EmaxCalo,binCalo,EminCalo,EmaxCalo);
TH2F *hGammaGammaP = new TH2F("hGammaGammaP","Gamma cal energy vs Gamma cal energy (predicted); Gamma cal energy (predicted), GeV;  Gamma cal energy, GeV", binCalo,EminCalo,EmaxCalo,binCalo,EminCalo,EmaxCalo);

TH2F *hscin4GammaP = new TH2F("hscin4GammaP","Gamma cal energy vs the signal of Scintillator 4; Scintillator 4 signal;  Gamma cal energy, GeV",100,0,20000,binCalo,EminCalo,EmaxCalo);
